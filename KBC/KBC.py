...
options=[
    ...
    ["Vamlmiki","Banabhata","Kalidas","Vishal","50:50"],            # Answer Options
...
solutions=[4,2,3,3,2,1]           # Solutions
solution_for_50_50=[[2,4],[2,3],[2,3],[3,1],[4,2],[1,4]]  # Solution for 50 50 option

def kbc(questions,options,solutions,solution_for_50_50):
...
kbc(questions,options,solutions,solution_for_50_50)